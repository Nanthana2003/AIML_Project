#######################################################
# CSE                                                 #   
# Project Name : Detect Credit Card Fraud Using AI ML #
#######################################################
...
class App:
    def __init__(self, root):
        ...
        #configure grid
        root.grid_rowconfigure(0, weight=0)  # configure grid system
        root.grid_rowconfigure(1, weight=0) 
        root.grid_rowconfigure(2, weight=20)
        root.grid_rowconfigure(3, weight=0)
        root.grid_columnconfigure(0, weight=1)
        # Get the directory of the script or .app
        ...
        def build_model():
            ...
            try:
                file_path = filedialog.askopenfilename(
                    filetypes=[("CSV files", "*.csv")],  # Limit file types to CSV
                    title="Select a CSV file",  # Dialog title
                )
            ...
            try:
                ...
                #Now, it’s time to split credit card data with a split of 80-20 using train_test_split()
        ...
        developer_label=ctk.CTkLabel(frame_row2,text="AIML Project",font=("calibri",9))
